...
export const wdPopup = (state = wdPopupData, action) =>{
  let WH = $(window).height();
  let PH = 500;
  switch (action.type){
    case 'POPUP_WD_SET_STATUS':
    ...
    case 'POPUP_WD_SET_RATE':
      return _.assign({}, state, {
        rate: action.rate
      });
    case 'POPUP_SET_WD_ERRORCODE':
      return _.assign({}, state, {
        errorCode: action.errorCode
      });
    case 'POPUP_WD_SET_SUBMIT_DISABLED':
      return _.assign({}, state, {
        submitDisabled: action.submitDisabled
      });
    case 'POPUP_WD_SET_SUBMIT_NEVERABLE':
      return _.assign({}, state, {
        submitNeverAble: action.submitNeverAble
      });

      //网贷弹框 转让接口
    case 'POPUP_WD_TRANS_LOADING':
      return _.assign({}, state, {
        transData:{  
          isFetching: action.status,
          data:state.transData.data.data ? state.transData.data : {}
        }
      });
    case 'POPUP_WD_TRANS_SUCCESS':
    ...
    case 'POPUP_WD_TRANS_ERROR':
      return _.assign({}, state, {
        ...
        //网贷弹框 撤销转让接口
    case 'POPUP_WD_CANCEL_TRANS_LOADING':
      return _.assign({}, state, {
        transCancelData:{  
          isFetching: action.status
        }
      });
    case 'POPUP_WD_CANCEL_TRANS_SUCCESS':
      return _.merge({}, state, {
        transCancelData:{  
          isFetching: action.status,
          data:action.data ? action.data : ""
    ...
    case 'POPUP_WD_CANCEL_TRANS_ERROR':
      return _.assign({}, state, {
        transCancelData:{  
          isFetching: action.status,
          error:action.error
      ...
      //网贷弹框 确认转让接口
    case 'POPUP_WD_SURE_TRANS_LOADING':
      return _.assign({}, state, {
        transOverData:{  
          isFetching: action.status
        }
      });
    case 'POPUP_WD_SURE_TRANS_SUCCESS':
      return _.merge({}, state, {
        transOverData:{  
          isFetching: action.status,
          data:action.data ? action.data : ""
    ...
    case 'POPUP_WD_SURE_TRANS_ERROR':
      return _.assign({}, state, {
        transOverData:{  
          isFetching: action.status,
          error:action.error
      ...
      //网贷弹框 确认撤销转让接口
    case 'POPUP_WD_SURE_CANCEL_TRANS_LOADING':
      return _.assign({}, state, {
        transOverCancelData:{  
          isFetching: action.status
        }
      });
    case 'POPUP_WD_SURE_CANCEL_TRANS_SUCCESS':
      return _.merge({}, state, {
        transOverCancelData:{  
          isFetching: action.status,
          data:action.data ? action.data : ""
    ...
    case 'POPUP_WD_SURE_CANCEL_TRANS_ERROR':
      return _.assign({}, state, {
        transOverCancelData:{  
          isFetching: action.status,
          error:action.error
