...
const Header = require('./complete-hyou-head.component').TableHead;
const List = require('./complete-hyou-body.component').List;
...
const CompleteMain = React.createClass({
  ...
  onChange:function(page){
    ...
    this.props.getCompleteListData(this.state.param);
    document.getElementById('completeHYOU').scrollIntoView();
  },
  render:function(){
    let list = '';
    let total = 0;
    ...
    <div className="invest-list-contain finish-over-list">
      <div className="invest-project" id="completeHYOU">
        <Info name="近期已满投资项目"/>
