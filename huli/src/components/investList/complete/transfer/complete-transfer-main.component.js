...
const Header = require('./complete-transfer-head.component').TableHead;
const List = require('./complete-transfer-body.component').List;
...
const CompleteMain = React.createClass({
  ...
  onChange:function(page){
    ...
    this.props.getCompleteListData(this.state.param);
    document.getElementById('completeTransfer').scrollIntoView();
  },
  render:function(){
    let list = '';
    let total = 0;
    ...
    <div className="invest-list-contain finish-over-list">
      <div className="invest-project" id="completeTransfer">
        <Info name="近期已成功转让项目"/>
