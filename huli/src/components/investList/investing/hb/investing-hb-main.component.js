...
const Header = require('./investing-hb-header.component').TableHead;
const List = require('./investing-hb-body.component').List;
...
const HYMain = React.createClass({
  ...
  onChange:function(page){
    ...
    this.props.getInvestingListData(this.state.param);
    document.getElementById('investingHB').scrollIntoView();
  },
  ...
  render:function(){
    ...
    if(this.props.investingList.isFetching == 1){
      if(!this.props.investingList.data.page.data || this.props.investingList.data.page.data.length == 0 ){
        ...
        total = this.props.investingList.data.huiBaoCount;
    ...
    <div className="invest-project" id="investingHB">
