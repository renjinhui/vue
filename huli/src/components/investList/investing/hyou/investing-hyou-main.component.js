...
const Header = require('./investing-hyou-header.component').TableHead;
const List = require('./investing-hyou-body.component').List;
...
const HYMain = React.createClass({
  ...
  onChange:function(page){
    ...
    this.props.getInvestingListData(this.state.param);
    document.getElementById('investingHYOU').scrollIntoView();
  },
  ...
  render:function(){
    ...
    if(this.props.investingList.isFetching == 1){
      if(!this.props.investingList.data.page.data || this.props.investingList.data.page.data.length == 0 ){
        ...
        total = this.props.investingList.data.huiYouCount;
    ...
    <div className="invest-project" id="investingHYOU">
      {/*<Intro name="慧优：权威诚荐 勤勉守信" />*/}
