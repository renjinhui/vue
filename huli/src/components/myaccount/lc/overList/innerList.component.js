...
const lcInnerList = React.createClass({
  ...
  render() {
    // 摇奖之前判断 item.receiptStatus == 1 && _this.props.over
     ...
     let list = '';
     let _this = this;
    let weiJToolTip = (this.props.state.lcData.tabOverList.data && this.props.state.lcData.tabOverList.data.data && this.props.state.lcData.tabOverList.data.data.receiptTip.replace(/&lt;/g, "<").replace(/&gt;/g, ">")) || '';
