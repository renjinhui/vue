...
const wdInnerList = React.createClass({
  ...
  componentDidMount() {
    if(window.addEventListener){
      ...
      this.scrollBox ?  this.scrollBox.addEventListener('DOMMouseScroll', this.handleScroll,false) : null;
    }else{
  ...
  componentDidUpdate(){
      ...
      // console.log(this.state.barH,this.state.boxH,this.state.domH,this.state.barBoxH,this.scrollBarBox)
  ...
  render() {
     ...
     let weiJToolTip = (this.props.state.wdData.tabNormalList.data&&this.props.state.wdData.tabNormalList.data.data) ? this.props.state.wdData.tabNormalList.data.data.receiptTip.replace(/&lt;/g, "<").replace(/&gt;/g, ">") : '';
