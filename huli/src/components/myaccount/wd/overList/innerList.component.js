...
const wdInnerList = React.createClass({
  getInitialState(){
    return {
        domH:0,
        boxH: 0,
  ...
  render() {
    // 摇奖之前判断 item.receiptStatus == 1 && _this.props.over
     ...
     let weiJToolTip = (this.props.state.wdData.tabOverList.data&&this.props.state.wdData.tabOverList.data.data )? this.props.state.wdData.tabOverList.data.data.receiptTip.replace(/&lt;/g, "<").replace(/&gt;/g, ">") : '';
     list =   item.repayPlanInfoVOList.map(function(value,ind){
                ...
                if(value.receiptStatus == 3){
                    inList  = <div className={value.receiptStatus !== 0 ? 'row bg-color' : 'row'} >
                                  ...
                                  <span className="grid-wh-80">{ToolTM(value.opTime,'-') || '\u00A0'}</span>
                                  <span className="grid-wh-20">&nbsp;</span>
                              </div>
                }else{
                    inList  = <div className={value.receiptStatus !== 0 ? 'row bg-color' : 'row'} >
                                  ...
                                  <span className="grid-wh-20">&nbsp;</span>
                                  <span className="grid-wh-80 ">{ToolTM(value.periodDate,'-') || '\u00A0'}</span>
                                  <span className="grid-wh-20">&nbsp;</span>
                                  <span className="grid-wh-1">&nbsp;</span>
                                        ...
                                        <table border="0" cellSpacing="0" cellPadding="0" width="100%" className="forhigh-td-35" style={{fontSize:'14px'}}>
                                            ...
                                            <tr>
                                                <td>
                                                    {value.handing != 0
                                                      ?
                                                      <div className="lt relative">
                                                        <ToolTip width='120px' data-text={weiJToolTip} />
                                                      </div> 
                                                      :null
                                                    }
                                              ...
                                              <td>
                                                  <span className={value.receiptStatus == 0 ? 'lt ' : 'lt payments'}>{value.receiptStatusStr || '\u00A0'}</span>
                                                {
                                                  ...
                                                  <div className="relative">
                                                    <ToolTip width='140px' data-text={value.repayStatusToolTip} />
                                                  </div>
                                                  :null
                                                }
                                              </td>
                ...
                return (
                  <div key={"inner"+ind}>
                    {
                      (ind == 0 && value.receiptStatus == 5) //购买转让
                      ?

                      <div className="row">
                          <span className="grid-wh-70 center-justified">-</span>
                          <span className="grid-wh-20">&nbsp;</span>
                          <span className="grid-wh-80 center-justified">-</span>
                          <span className="grid-wh-20">&nbsp;</span>
                          <span className="grid-wh-1 right-justified">&nbsp;</span>

                          <span className="grid-wh-90 right-justified">{ToolPE(value.principalInterestSum) || '\u00A0'}</span>
                          <span className="grid-wh-90 right-justified">-</span>
                          <span className="grid-wh-95 right-justified">{ToolPE(value.interest) || '\u00A0'}</span>
    ...
    return (
        <div className="sydinlist-spreads" style={{display:isShow}}>
            <div className="theh">
                ...
                <span className="grid-wh-90 right-justified">本金</span>
            ...
            <div className="sydinlist-subqueue relative" style={{height: '210px'}}>
                        ...
                        {list}
                        {
                          ...
                          <div className="sydinlist-fill">
                              ...
                              <div className="aside">
                                  ...
                                  {
                                    item.repayPlanInfoVOList[repLength].receiptStatus != 0
                                    ?
                                    <div className="row">
                                        <span className="grid-wh-10">&nbsp;</span>
                                        <span className="grid-wh-100">{ToolTM(item.repayPlanInfoVOList[repLength].periodDate,'-') || '\u00A0'}</span>
                                        <span className="grid-wh-90 right-justified"><span className="font-wr">摇奖：</span>{ToolPE(item.randomInterest) || '\u00A0'}</span>
                                        <span className="grid-wh-50">&nbsp;</span>
                                        <span>
                                            <span className="font-wr">待最后一次补贴</span>
                                        </span>
...
export const WdInnerList = connect(
